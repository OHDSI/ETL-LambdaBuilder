...
SELECT * INTO {TARGET_SCHEMA}.source_to_source_vocab_map FROM CTE_VOCAB_MAP;

create index idx_source_vocab_map_source_code on {TARGET_SCHEMA}.source_to_source_vocab_map (source_code);
create index idx_source_vocab_map_source_vocab_id on {TARGET_SCHEMA}.source_to_source_vocab_map (source_vocabulary_id);
