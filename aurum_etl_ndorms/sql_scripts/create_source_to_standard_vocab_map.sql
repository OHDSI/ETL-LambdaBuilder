drop table if exists {TARGET_SCHEMA}.source_to_standard_vocab_map;
...
WITH CTE_VOCAB_MAP AS (
       ...
       FROM {TARGET_SCHEMA}.source_to_concept_map stcm
...
select * into {TARGET_SCHEMA}.source_to_standard_vocab_map from CTE_VOCAB_MAP;

create index idx_vocab_map_source_code on {TARGET_SCHEMA}.source_to_standard_vocab_map (source_code);
create index idx_vocab_map_source_vocab_id on {TARGET_SCHEMA}.source_to_standard_vocab_map (source_vocabulary_id);
