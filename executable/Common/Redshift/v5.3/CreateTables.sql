...
CREATE TABLE {sc}.VISIT_DETAIL 
	...
	VISIT_DETAIL_START_DATETIME VARCHAR(10) NULL,
	VISIT_DETAIL_END_DATE DATE NOT NULL,
	VISIT_DETAIL_END_DATETIME VARCHAR(10) NULL,
...
CREATE TABLE {sc}.PROCEDURE_OCCURRENCE 
    ( 
	 ...
	 PROCEDURE_DATETIME				VARCHAR(10)		NULL ,
...
CREATE TABLE {sc}.DRUG_EXPOSURE 
    ( 
	 ...
	 DRUG_EXPOSURE_START_DATETIME	VARCHAR(10)		NULL ,
...
CREATE TABLE {sc}.DEVICE_EXPOSURE 
    ( 
	 ...
	 DEVICE_EXPOSURE_START_DATETIME	VARCHAR(10)		NULL ,
...
CREATE TABLE {sc}.CONDITION_OCCURRENCE 
    ( 
	 ...
	 CONDITION_START_DATETIME		VARCHAR(10)		NULL ,
...
(
    ...
    cost_event_id bigint NOT NULL DISTKEY, 
