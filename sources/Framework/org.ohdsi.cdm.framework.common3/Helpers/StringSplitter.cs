...
namespace org.ohdsi.cdm.framework.common.Helpers
{
    ...
    public class StringSplitter(int bufferSize)
    {

        /// <summary>
        /// The string buffer container
        /// </summary>
        private string[] _buffer = new string[bufferSize];
        ...
        public int Split(string value, char separator)
        {
            ...
            for (int i = 0; i < value.Length; i++)
            {
                ...
                {
                    this._buffer[resultIndex] = value[startIndex..i];
                    resultIndex++;
                    startIndex = i + 1;
                }
            }
            ...
            // Find the last part
            this._buffer[resultIndex] = value[startIndex..];
            resultIndex++;
