{base},
Standard as (
SELECT distinct ROW_NUMBER() OVER(partition by SOURCE_CODE ORDER BY TARGET_VOCABULARY_ID ASC) AS row_num, SOURCE_CODE, TARGET_CONCEPT_ID, TARGET_DOMAIN_ID, SOURCE_VALID_START_DATE as VALID_START_DATE, SOURCE_VALID_END_DATE as VALID_END_DATE, SOURCE_VOCABULARY_ID, TARGET_VOCABULARY_ID, TARGET_VALUE_AS_CONCEPT_ID
