...
WHERE lower(SOURCE_VOCABULARY_ID) IN ('cpt4', 'hcpcs', 'icd10cm', 'icd10pcs', 'icd9cm', 'icd9proc' )
AND lower(TARGET_VOCABULARY_ID) IN ('cpt4', 'hcpcs', 'icd10cm', 'icd10pcs', 'icd9cm', 'icd9proc' ) AND lower(TARGET_DOMAIN_ID)='procedure'
), S_S as
(
