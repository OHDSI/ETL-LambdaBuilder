...
WHERE lower(SOURCE_VOCABULARY_ID) IN ('cpt4', 'hcpcs', 'icd10cm', 'icd9cm', 'jnj_pmr_proc_chrg_cd')
...
AND lower(TARGET_VOCABULARY_ID) IN ('cpt4', 'hcpcs') AND lower(TARGET_DOMAIN_ID)='measurement'
), S_S as
(
