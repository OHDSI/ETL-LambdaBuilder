...
{
    public class DeviceCostDataReader(List<DeviceCost> batch, KeyMasterOffsetManager o) : IDataReader
    {
        private readonly IEnumerator<DeviceCost> _enumerator = batch?.GetEnumerator();
        ...
        public object GetValue(int i)
        {
            ...
            return i switch
            {
                0 => _offset.GetId(_enumerator.Current.PersonId, _enumerator.Current.DeviceCostId),
                ...
                10 => (object)(_enumerator.Current.PayerPlanPeriodId.HasValue
