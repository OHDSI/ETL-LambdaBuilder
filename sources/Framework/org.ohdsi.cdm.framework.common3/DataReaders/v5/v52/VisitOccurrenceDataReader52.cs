...
{
    public class VisitOccurrenceDataReader52(List<VisitOccurrence> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                12 => "admitting_source_concept_id",
                13 => "admitting_source_value",
                14 => "discharge_to_concept_id",
