...
{
    public class ProcedureCostDataReader(List<ProcedureCost> batch, KeyMasterOffsetManager o) : IDataReader
    {
        private readonly IEnumerator<ProcedureCost> _enumerator = batch?.GetEnumerator();
        ...
        public object GetValue(int i)
        {
            ...
            return i switch
            {
                0 => _offset.GetId(_enumerator.Current.PersonId, _enumerator.Current.ProcedureCostId),
                ...
                10 => _enumerator.Current.RevenueCodeConceptId,
                11 => _enumerator.Current.PayerPlanPeriodId.HasValue
                ...
                12 => _enumerator.Current.RevenueCodeSourceValue,
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                8 => "TotalOutOfPocket",
                9 => "TotalPaid",
                10 => "RevenueCodeConceptId",
                11 => "PayerPlanPeriodId",
                12 => "RevenueCodeSourceValue",
                _ => throw new NotImplementedException(),
            };
        }
