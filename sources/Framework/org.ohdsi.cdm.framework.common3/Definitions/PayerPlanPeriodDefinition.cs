    ...
    public class PayerPlanPeriodDefinition : EntityDefinition
    {
            ...
            KeyMasterOffsetManager keyOffset)
        {
            ...
            if (personId.HasValue)
            {
                ...
                long payerConceptId = 0;
                long payerSourceConceptId = 0;

                long planConceptId = 0;
                long planSourceConceptId = 0;

                long sponsorConceptId = 0;
                long sponsorSourceConceptId = 0;
                string sponsorSource = null;

                long stopReasonConceptId = 0;
                long stopReasonSourceConceptId = 0;
