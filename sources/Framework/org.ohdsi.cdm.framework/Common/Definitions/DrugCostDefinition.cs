...
namespace org.ohdsi.cdm.framework.common.Definitions
{
    ...
    {
        public DrugCost CreateEnity(DrugExposure drugExposure, IDataRecord reader, KeyMasterOffsetManager offset)
        {
            ...
            {
                DrugCostId = offset.GetKeyOffset(drugExposure.PersonId).DrugCostId,
