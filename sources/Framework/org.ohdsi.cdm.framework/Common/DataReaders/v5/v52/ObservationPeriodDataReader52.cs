...
{
    public class ObservationPeriodDataReader52(List<ObservationPeriod> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public object GetValue(int i)
        {
            ...
            return i switch
            {
                ...
                3 => _enumerator.Current.StartDate.TimeOfDay,
                4 => _enumerator.Current.EndDate,
                5 => _enumerator.Current.EndDate?.TimeOfDay,
                6 => _enumerator.Current.TypeConceptId,
