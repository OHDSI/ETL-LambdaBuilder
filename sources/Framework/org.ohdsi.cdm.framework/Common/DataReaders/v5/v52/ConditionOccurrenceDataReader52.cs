...
{
    public class ConditionOccurrenceDataReader52(List<ConditionOccurrence> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                8 => "StopReason",
                9 => "ProviderId",
                10 => "VisitOccurrenceId",
                11 => "StatusConceptId",
                12 => "SourceValue",
                13 => "SourceConceptId",
                14 => "StatusSourceValue",
