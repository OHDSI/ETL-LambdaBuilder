...
{
    public class ProcedureOccurrenceDataReader53(List<ProcedureOccurrence> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                5 => "procedure_type_concept_id",
                6 => "modifier_concept_id",
                7 => "quantity",
                8 => "provider_id",
                9 => "visit_occurrence_id",
                10 => "visit_detail_id",
                11 => "procedure_source_value",
                12 => "procedure_source_concept_id",
                13 => "modifier_source_value",
