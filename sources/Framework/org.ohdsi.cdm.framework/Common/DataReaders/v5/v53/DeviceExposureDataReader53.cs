...
{
    public class DeviceExposureDataReader53(List<DeviceExposure> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                12 => "visit_detail_id",
                13 => "device_source_value",
                14 => "device_source_concept_id",
