...
{
    public class MeasurementDataReader53(List<Measurement> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public object GetValue(int i)
        {
            ...
            switch (i)
            {
                ...
                case 9:
                    if (!_enumerator.Current.ValueAsConceptId.HasValue && !string.IsNullOrEmpty(_enumerator.Current.ValueSourceValue))
                        return 0;
