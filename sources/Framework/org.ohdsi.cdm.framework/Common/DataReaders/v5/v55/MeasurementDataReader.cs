...
{
    public class MeasurementDataReader(List<Measurement> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                19 => "value_as_source_concept_Id",
                20 => "unit_source_concept_id",
                21 => "value_source_value",
                22 => "measurement_event_id",
                23 => "meas_event_field_concept_id",
