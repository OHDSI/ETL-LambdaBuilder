...
namespace org.ohdsi.cdm.framework.common.DataReaders.v5.v55
{
    public class ObservationDataReader(List<Observation> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public object GetValue(int i)
        {
            switch (i)
            {
                ...
                case 9:
                    return null; // TMP CDM 5.5 value_as_date
                case 10:
                ...
                case 18:
                    return null; // TMP CDM 5.5 unit_source_concept_id
                case 19:
                    return _enumerator.Current.QualifierSourceValue;
                case 20:
                    return _enumerator.Current.ValueSourceValue;
                case 21:
                    return null; // TMP CDM 5.5 value_as_source_concept_id
                case 22:
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                14 => "visit_detail_id",
                15 => "observation_source_value",
                16 => "observation_source_concept_id",
                17 => "unit_source_value",
                18 => "unit_source_concept_id",
                19 => "qualifier_source_value",
                20 => "value_source_value",
                21 => "value_as_source_concept_id",
                22 => "observation_event_id",
                23 => "obs_event_field_concept_id",
