...
{
    public class VisitCostDataReader(List<VisitCost> batch, KeyMasterOffsetManager o) : IDataReader
    {
        private readonly IEnumerator<VisitCost> _enumerator = batch?.GetEnumerator();
        ...
        public object GetValue(int i)
        {
            ...
            return i switch
            {
                0 => _offset.GetId(_enumerator.Current.PersonId, _enumerator.Current.VisitCostId),
