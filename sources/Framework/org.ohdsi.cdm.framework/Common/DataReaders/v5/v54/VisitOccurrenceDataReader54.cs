...
{
    public class VisitOccurrenceDataReader54(List<VisitOccurrence> batch, KeyMasterOffsetManager o) : IDataReader
    {
        ...
        public string GetName(int i)
        {
            return i switch
            {
                ...
                14 => "discharged_to_concept_id",
                15 => "discharged_to_source_value",
