...
namespace org.ohdsi.cdm.framework.etl.Transformation.OptumExtended
{
    /// <summary>
    ...
    public class OptumExtendedPersonBuilder : PersonBuilder
    {
        ...
        private class OptumExtendedSESPersonBuilder : OptumExtendedPersonBuilder
        {
            public OptumExtendedSESPersonBuilder(Vendor vendor)
                : base(vendor)
            {
        ...
        private class OptumExtendedDODPersonBuilder : OptumExtendedPersonBuilder
        {
            public OptumExtendedDODPersonBuilder(Vendor vendor)
                : base(vendor)
            {
        ...
        public class OptumExtendedSESVendor : Vendor
        {
            ...
            public override string PersonTableName => "MEMBER_CONTINUOUS_ENROLLMENT";
        ...
        public OptumExtendedPersonBuilder(Vendor vendor)
            : base(vendor)
        {
            if (
                vendor is not OptumExtendedSESVendor
             && vendor is not OptumExtendedDODVendor
                )
