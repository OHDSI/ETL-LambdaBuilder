...
namespace org.ohdsi.cdm.framework.etl.Transformation.Truven
{
    ...
    public class TruvenPersonBuilder : PersonBuilder
    {
        ...
        private class Truven_CCAEPersonBuilder : TruvenPersonBuilder
        {
            public Truven_CCAEPersonBuilder(Vendor vendor)
                : base(vendor)
            {
                if (vendor is not Truven_CCAEVendor)
                    throw new Exception($"Unsupported vendor type: {vendor.GetType().Name}");

            }
        }

        private class Truven_MDCDPersonBuilder : TruvenPersonBuilder
        {
            public Truven_MDCDPersonBuilder(Vendor vendor)
                : base(vendor)
            {
                if (vendor is not Truven_MDCDVendor)
                    throw new Exception($"Unsupported vendor type: {vendor.GetType().Name}");
            }

        }

        private class Truven_MDCRPersonBuilder : TruvenPersonBuilder
        {
            public Truven_MDCRPersonBuilder(Vendor vendor)
                : base(vendor)
            {
                if (vendor is not Truven_MDCRVendor)
                    throw new Exception($"Unsupported vendor type: {vendor.GetType().Name}");
            }
        ...
        public class Truven_CCAEVendor : Vendor
        {
            ...
            public override string Description => "Truven CCAE v5.4";
            public override string CdmSource => "CdmSourceCCAE.sql";
            public override CdmVersions CdmVersion => CdmVersions.V54;
            public override int PersonIdIndex => 0;
            public override string PersonTableName => "ENROLLMENT_DETAIL";
        ...
        public class Truven_MDCDVendor : Vendor
        {
            ...
            public override string Folder => "Truven";
            public override string Description => "Truven MDCD v5.4";
            public override string CdmSource => "CdmSourceMDCD.sql";
            public override CdmVersions CdmVersion => CdmVersions.V54;
            public override int PersonIdIndex => 0;
            public override string PersonTableName => "ENROLLMENT_DETAIL";
            public override string Citation => "Follow the proper use of trademarks as detailed by IBM. The document with the information on how to do so can be found on the rwe catalog.";
            public override string Publication => "No review requirements.";
        }
        ...
        public class Truven_MDCRVendor : Vendor
        {
            ...
            public override string Folder => "Truven";
            public override string Description => "Truven MDCR v5.4";
            public override string CdmSource => "CdmSourceMDCR.sql";
            public override CdmVersions CdmVersion => CdmVersions.V54;
            public override int PersonIdIndex => 0;
            public override string PersonTableName => "ENROLLMENT_DETAIL";
            public override string Citation => "";
            public override string Publication => "";
        }
        ...
        public TruvenPersonBuilder(Vendor vendor)
            : base(vendor)
        {
            if (
                vendor is not Truven_CCAEVendor
             && vendor is not Truven_MDCDVendor
             && vendor is not Truven_MDCRVendor
                )
                throw new Exception($"Unsupported vendor type: {vendor.GetType().Name}");
        }
