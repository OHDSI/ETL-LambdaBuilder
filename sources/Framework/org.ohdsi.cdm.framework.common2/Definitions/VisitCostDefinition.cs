...
namespace org.ohdsi.cdm.framework.common2.Definitions
{
    ...
    {
        public VisitCost CreateEnity(VisitOccurrence visit, IDataRecord reader, KeyMasterOffsetManager offset)
        {
            ...
            {
                VisitCostId = KeyMasterOffsetManager.GetKeyOffset(visit.PersonId).VisitCostId,
                PaidCopay = paidCopay,
