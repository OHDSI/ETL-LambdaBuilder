...
{
    //public class ProcedureCostOrig : ProcedureOccurrence, IEquatable<ProcedureCostOrig>, ICostV5
    //{
    ...
    //    public ProcedureCostOrig(ProcedureOccurrence ent)
    //        : base(ent)
    //    {
    //        Init(ent);
    ...
    //    public bool Equals(ProcedureCostOrig other)
    //    {
