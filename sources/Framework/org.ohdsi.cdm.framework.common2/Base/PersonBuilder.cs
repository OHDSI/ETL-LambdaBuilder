...
namespace org.ohdsi.cdm.framework.common2.Base
{
    /// <summary>
    ...
    public class PersonBuilder : IPersonBuilder
    {
        ...
        protected readonly List<EraEntity> ObservationPeriodsRaw = new List<EraEntity>();
        protected readonly List<Person> PersonRecords = new List<Person>();
        protected readonly List<Death> DeathRecords = new List<Death>();
        protected readonly List<Cohort> CohortRecords = new List<Cohort>();

        protected readonly List<PayerPlanPeriod>
            PayerPlanPeriodsRaw = new List<PayerPlanPeriod>();

        protected readonly List<ConditionOccurrence> ConditionOccurrencesRaw =
            new List<ConditionOccurrence>();

        protected readonly List<DrugExposure> DrugExposuresRaw = new List<DrugExposure>();

        protected readonly List<ProcedureOccurrence> ProcedureOccurrencesRaw =
            new List<ProcedureOccurrence>();

        protected readonly List<Observation> ObservationsRaw = new List<Observation>();
        protected readonly List<Measurement> MeasurementsRaw = new List<Measurement>();

        protected readonly List<VisitOccurrence>
            VisitOccurrencesRaw = new List<VisitOccurrence>();

        protected readonly List<VisitDetail>
            VisitDetailsRaw = new List<VisitDetail>();

        protected readonly List<VisitCost> VisitCostsRaw = new List<VisitCost>();
        protected readonly List<DeviceExposure> DeviceExposureRaw = new List<DeviceExposure>();
        protected readonly List<DeviceCost> DeviceCostRaw = new List<DeviceCost>();
        ...
        protected readonly List<Note> NoteRecords = new List<Note>();
        ...
        public IEnumerable<Note> BuildNote(Note[] notes, Dictionary<long, VisitOccurrence> visitOccurrences,
            ObservationPeriod[] observationPeriods)
        {
            return BuildEntities(notes, visitOccurrences, observationPeriods, true);
        }
