...
namespace org.ohdsi.cdm.framework.common2.Core.Transformation.Truven
{
    /// <summary>
        ...
        public override Attrition Build(ChunkData data, KeyMasterOffsetManager o)
        {
            ...
            foreach (var procedureOccurrence in procedureOccurrences)
            {
                procedureOccurrence.Id =
                    KeyMasterOffsetManager.GetKeyOffset(procedureOccurrence.PersonId).ProcedureOccurrenceId;
            ...
            {
                ob.Id = KeyMasterOffsetManager.GetKeyOffset(ob.PersonId).ObservationId;
            }
            ...
            {
                ChunkData.AddCostData(cost.CreateCost(KeyMasterOffsetManager.GetKeyOffset(cost.PersonId).VisitCostId));
            }
