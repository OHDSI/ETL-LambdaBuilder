    ...
    public class PremierPersonBuilder : PersonBuilder
    {
        ...
        public override Attrition Build(ChunkData data, KeyMasterOffsetManager o)
        {
            ...
            foreach (var vo in cleanedVisits)
            {
                ...
                {
                    Id = KeyMasterOffsetManager.GetKeyOffset(vo.PersonId).ObservationPeriodId,
            ...
            foreach (var v5 in visitCosts)
            {
                ...
                {
                    CostId = KeyMasterOffsetManager.GetKeyOffset(v5.PersonId).VisitCostId,
            ...
            Dictionary<long, VisitOccurrence> visitOccurrences)
        {
            ...
            {
                payerPlanPeriod.Id = KeyMasterOffsetManager.GetKeyOffset(payerPlanPeriod.PersonId).PayerPlanPeriodId;
