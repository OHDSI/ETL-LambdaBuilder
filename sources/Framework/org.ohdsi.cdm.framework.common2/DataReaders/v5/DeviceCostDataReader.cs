...
namespace org.ohdsi.cdm.framework.common2.DataReaders.v5
{
    ...
    {
        private readonly IEnumerator<DeviceCost> _enumerator;

        // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
        public DeviceCostDataReader(List<DeviceCost> batch)
        {
        ...
        public object GetValue(int i)
        {
            ...
            {
                case 0:
                    return KeyMasterOffsetManager.GetId(_enumerator.Current.PersonId, _enumerator.Current.DeviceCostId);
                case 1:
