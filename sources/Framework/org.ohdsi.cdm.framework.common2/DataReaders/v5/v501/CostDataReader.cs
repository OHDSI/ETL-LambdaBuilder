...
namespace org.ohdsi.cdm.framework.common2.DataReaders.v5.v501
{
    public class CostDataReader : IDataReader
    {
        ...
        public CostDataReader(List<Cost> batch)
        {
        ...
        public object GetValue(int i)
        {
            ...
            switch (i)
            {
                ...
                case 1:
                    if (_enumerator.Current.Domain == "Visit" && !KeyMasterOffsetManager
                            .GetKeyOffset(_enumerator.Current.PersonId).VisitOccurrenceIdChanged)
                        return _enumerator.Current.EventId;

                    return KeyMasterOffsetManager.GetId(_enumerator.Current.PersonId, _enumerator.Current.EventId);
