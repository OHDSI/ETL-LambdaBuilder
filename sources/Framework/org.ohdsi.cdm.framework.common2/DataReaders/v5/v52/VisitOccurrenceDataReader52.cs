...
namespace org.ohdsi.cdm.framework.common2.DataReaders.v5.v52
{
    public class VisitOccurrenceDataReader52 : IDataReader
    {
        ...
        public VisitOccurrenceDataReader52(List<VisitOccurrence> batch)
        {
        ...
        public object GetValue(int i)
        {
            switch (i)
            {
                case 0:
                {
                    return KeyMasterOffsetManager.GetKeyOffset(_enumerator.Current.PersonId).VisitOccurrenceIdChanged
