...
namespace org.ohdsi.cdm.framework.common2.DataReaders.v5.v53
{
    public class VisitDetailDataReader53 : IDataReader
    {
        ...
        public VisitDetailDataReader53(List<VisitDetail> batch)
        {
        ...
        public object GetValue(int i)
        {
            switch (i)
            {
                case 0:
                {
                    return KeyMasterOffsetManager.GetKeyOffset(_enumerator.Current.PersonId).VisitDetailIdChanged
                        ? KeyMasterOffsetManager.GetId(_enumerator.Current.PersonId, _enumerator.Current.Id)
                ...
                case 17:
                    return _enumerator.Current.VisitDetailParentId;
