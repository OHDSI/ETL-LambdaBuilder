...
{
    public class PayerPlanPeriodDataReader53 : IDataReader
    {
        private readonly IEnumerator<PayerPlanPeriod> _enumerator;

        // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
        public PayerPlanPeriodDataReader53(List<PayerPlanPeriod> batch)
        {
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                ...
                case 2: return "payer_plan_period_start_date";
                case 3: return "payer_plan_period_end_date";
                case 4: return "payer_concept_id";
                case 5: return "payer_source_value";
                case 6: return "payer_source_concept_id";
                case 7: return "plan_concept_id";
                case 8: return "plan_source_value";
                case 9: return "plan_source_concept_id";
                case 10: return "sponsor_concept_id";
                case 11: return "sponsor_source_value";
                case 12: return "sponsor_source_concept_id";
                case 13: return "family_source_value";
                case 14: return "stop_reason_concept_id";
                case 15: return "stop_reason_source_value";
                case 16: return "stop_reason_source_concept_id";
