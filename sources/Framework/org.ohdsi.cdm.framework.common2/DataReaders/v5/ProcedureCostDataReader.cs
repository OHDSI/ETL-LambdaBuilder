...
{
    public class ProcedureCostDataReader : IDataReader
    {
        private readonly IEnumerator<ProcedureCost> _enumerator;

        // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
        public ProcedureCostDataReader(List<ProcedureCost> batch)
        {
