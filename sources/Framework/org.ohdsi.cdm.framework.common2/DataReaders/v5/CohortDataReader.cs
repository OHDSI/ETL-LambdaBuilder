...
namespace org.ohdsi.cdm.framework.common2.DataReaders.v5
{
    ...
    {
      private readonly IEnumerator<Cohort> _cohortEnumerator;
      ...
      public object GetValue(int i)
      {
         switch (i)
         {
            ...
            case 1:
                 return _cohortEnumerator.Current.PersonId;
            case 2:
               return _cohortEnumerator.Current.StartDate;
            case 3:
               return _cohortEnumerator.Current.EndDate;
      ...
      public string GetName(int i)
      {
         switch (i)
         {
             ...
             case 2: return "cohort_start_date";
             case 3: return "cohort_end_date";
