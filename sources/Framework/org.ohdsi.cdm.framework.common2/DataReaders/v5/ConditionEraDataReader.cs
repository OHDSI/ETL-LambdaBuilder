...
namespace org.ohdsi.cdm.framework.common2.DataReaders.v5 
{
   public class ConditionEraDataReader : IDataReader
   {
      ...
      public ConditionEraDataReader(List<EraEntity> batch)
      {
      ...
      public object GetValue(int i)
      {
         ...
         {
            case 0:
               return KeyMasterOffsetManager.GetId(_conditionEnumerator.Current.PersonId, _conditionEnumerator.Current.Id);
                case 1:
