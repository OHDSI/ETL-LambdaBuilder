...
Execute unit tests
```
    cd "org.ohdsi.cdm.presentation.lambdapregnancyepisodes/test/org.ohdsi.cdm.presentation.lambdapregnancyepisodes.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "org.ohdsi.cdm.presentation.lambdapregnancyepisodes/src/org.ohdsi.cdm.presentation.lambdapregnancyepisodes"
