    ...
    public partial class MainWindow
    {
        ...
        private static bool IsBuilderConnectionUnavailable()
        {
            ...
            try
            {
                ...
                using (
                    var connection =
                        SqlConnectionHelper.OpenMssqlConnection(ConfigurationManager.ConnectionStrings["Builder"]
                            .ConnectionString)
                )
                {
                }
        ...
        private static bool CreateBuilderDB()
        {
            ...
            MessageBox.Show(
                "Connection to Builder database not available.", "Configuration error", MessageBoxButton.OK,
