...
Execute unit tests
```
    cd "org.ohdsi.cdm.presentation.lambdamerge/test/org.ohdsi.cdm.presentation.lambdamerge.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "org.ohdsi.cdm.presentation.lambdamerge/src/org.ohdsi.cdm.presentation.lambdamerge"
