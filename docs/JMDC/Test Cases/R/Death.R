...
createDeathTests <- function () {
	...
	add_enrollment(member_id = "M000000602", withdrawal_death_flag = "1")
	...
	add_enrollment(member_id = "M000000604", withdrawal_death_flag = "1", observation_start = "201001", observation_end = "201112")
	...
	add_enrollment(member_id = "M000000606", withdrawal_death_flag = "1", observation_start = "201001", observation_end = "201112")
	...
	add_enrollment(member_id = "M000000607", withdrawal_death_flag = "1")
	...
	expect_death(person_id = 607, death_type_concept_id = 32815)
	expect_death(person_id = 608, death_type_concept_id = 32812)
}