...
| VALUE_AS_CONCEPT_ID | PDX, DX1-15 | Use the Source-to-Standard Query, but with **'Maps to value'** relationsip, how to define SOURCE_CONCEPT_ID the Source-to-Standard Query is applied to see in SOURCE_CONCEPT_ID field  | - |
