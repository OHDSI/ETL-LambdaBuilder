...
--DROP TABLE ccae_tests_native._pos_episode_visit;
CREATE TABLE ccae_tests_native._pos_episode_visit
(
	episode_id BIGINT   
	,enrolid BIGINT   
	,dt_start DATE   
...
--DROP TABLE ccae_tests_native._version;
CREATE TABLE ccae_tests_native._version
(
	version_id INTEGER   
	,version_date DATE   
)
...
--DROP TABLE ccae_tests_native.cpt4;
CREATE TABLE ccae_tests_native.cpt4
(
	cpt_code CHAR(5)   
	,cpt_desc VARCHAR(50)   
)
...
--DROP TABLE ccae_tests_native.drug_claims;
CREATE TABLE ccae_tests_native.drug_claims
(
	_flag SMALLINT   
	,age SMALLINT   
	,agegrp CHAR(1)   
...
--DROP TABLE ccae_tests_native.enrollment_detail;
CREATE TABLE ccae_tests_native.enrollment_detail
(
	_flag SMALLINT   
	,age SMALLINT   
	,agegrp CHAR(1)   
...
--DROP TABLE ccae_tests_native.enrollment_summary;
CREATE TABLE ccae_tests_native.enrollment_summary
(
	_flag SMALLINT   
	,age SMALLINT   
	,agegrp CHAR(1)   
...
--DROP TABLE ccae_tests_native.facility_header;
CREATE TABLE ccae_tests_native.facility_header
(
	_flag SMALLINT   
	,age SMALLINT   
	,agegrp CHAR(1)   
...
--DROP TABLE ccae_tests_native.geoloc;
CREATE TABLE ccae_tests_native.geoloc
(
	egeoloc CHAR(2)   
...
--DROP TABLE ccae_tests_native.health_risk_assessment;
CREATE TABLE ccae_tests_native.health_risk_assessment
(
	_flag SMALLINT   
	,alc_amt CHAR(1)   
	,alcdyamt CHAR(1)   
...
--DROP TABLE ccae_tests_native.hra_question_ref;
CREATE TABLE ccae_tests_native.hra_question_ref
(
...
--DROP TABLE ccae_tests_native.hra_variable_ref;
CREATE TABLE ccae_tests_native.hra_variable_ref
(
	variable_name VARCHAR(255)   
	,variable_longname VARCHAR(255)   
	,variable_description VARCHAR(255)   
	,notes VARCHAR(255)   
	,question_type_id FLOAT   
)
...
--DROP TABLE ccae_tests_native.icd9;
CREATE TABLE ccae_tests_native.icd9
(
	icd_key VARCHAR(9)   
	,icd_code VARCHAR(9)   
...
--DROP TABLE ccae_tests_native.inpatient_admissions;
CREATE TABLE ccae_tests_native.inpatient_admissions
(
	_flag SMALLINT   
	,admdate DATE   
	,admtyp CHAR(1)   
...
--DROP TABLE ccae_tests_native.inpatient_services;
CREATE TABLE ccae_tests_native.inpatient_services
(
	_flag SMALLINT   
	,admdate DATE   
	,admtyp CHAR(1)   
...
--DROP TABLE ccae_tests_native.lab;
CREATE TABLE ccae_tests_native.lab
(
	enrolid BIGINT   
	,seqnum BIGINT   
	,abnormal CHAR(1)   
...
--DROP TABLE ccae_tests_native.loinc;
CREATE TABLE ccae_tests_native.loinc
(
	loinc_num CHAR(7)   
...
--DROP TABLE ccae_tests_native.outpatient_services;
CREATE TABLE ccae_tests_native.outpatient_services
(
	_flag SMALLINT   
	,age SMALLINT   
	,agegrp CHAR(1)   
...
--DROP TABLE ccae_tests_native.red_book;
CREATE TABLE ccae_tests_native.red_book
(
	_flag SMALLINT   
	,deaclas CHAR(1)   
	,deaclds VARCHAR(50)   
