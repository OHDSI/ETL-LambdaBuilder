initFramework <- function() {
  ...
  defaults$netpay <- '0.0'
  defaults$pay <- '0.0'
  defaults$pddate <- '2017-01-20'
  defaults$plantyp <- '4'
  defaults$qty <- '1'
  defaults$refill <- '0'
  defaults$seqnum <- '33815395'
  defaults$sex <- '2'
  defaults$stdrace <- '1'
  defaults$svcdate <- '2017-08-28'
  defaults$thercls <- '69'
  defaults$thergrp <- '08'
  defaults$version <- '10'
  defaults$year <- '2016'
  ...
  defaults$dobyr <- '2006'
  defaults$drugcovg <- '1'
  defaults$dtend <- '2017-06-30'
  defaults$dtstart <- '2017-06-01'
  defaults$enrolid <- '20043404437'
  defaults$mas <- '9'
  defaults$medicare <- '0'
  defaults$memdays <- '31'
  defaults$mhsacovg <- '1'
  defaults$plantyp <- '4'
  defaults$seqnum <- '43537441'
  defaults$sex <- '2'
  defaults$stdrace <- '1'
  defaults$version <- '10'
  defaults$year <- '2017'
  ...
  defaults$dstatus <- '01'
  defaults$dx1 <- 'V221   '
  defaults$enrolid <- '20022353510'
  defaults$fachdid <- '5521242'
  defaults$mas <- '9'
  defaults$mdc <- '23'
  defaults$medicare <- '0'
  defaults$mhsacovg <- '1'
  ...
  defaults$proc5 <- '9904'
  defaults$proc6 <- '9672'
  defaults$seqnum <- '5521242'
  defaults$sex <- '2'
  defaults$stdplac <- '22'
  defaults$stdprov <- '1'
  defaults$stdrace <- '1'
  defaults$svcdate <- '2019-10-01'
  defaults$tsvcdat <- '2017-05-31'
  defaults$version <- '10'
  defaults$year <- '2015'
  assign('facility_header', defaults, envir = frameworkContext$defaultValues)

  defaults <- list()
  defaults$admdate <- '2015-10-05'
  defaults$admtyp <- '3'
  defaults$boe <- '5'
  defaults$cap <- '0'
  defaults$caseid <- '366313'
  defaults$days <- '2'
  defaults$disdate <- '2014-08-14'
  defaults$dobyr <- '2015'
  defaults$drg <- '795'
  defaults$drugcovg <- '1'
  defaults$dstatus <- '01'
  ...
  defaults <- list()
  defaults$admdate <- '2016-02-15'
  defaults$admtyp <- '2'
  defaults$boe <- '2'
  defaults$cap <- '0'
  defaults$caseid <- '633982'
  defaults$cob <- '0.0'
  defaults$coins <- '0.0'
  defaults$copay <- '0.0'
  defaults$deduct <- '0.0'
  defaults$disdate <- '2015-04-17'
  defaults$dobyr <- '1957'
  defaults$drg <- '775'
  defaults$drugcovg <- '1'
  defaults$dstatus <- '01'
  ...
  defaults$proctyp <- '1'
  defaults$qty <- '1'
  defaults$seqnum <- '13079562'
  defaults$sex <- '2'
  defaults$stdplac <- '21'
  defaults$stdprov <- '1'
  defaults$stdrace <- '1'
  defaults$svcdate <- '2019-02-05'
  defaults$svcscat <- '20226'
  defaults$tsvcdat <- '2019-02-11'
  defaults$version <- '10'
  defaults$year <- '2014'
  ...
  defaults$drugcovg <- '0'
  defaults$dxver <- '0'
  defaults$enrolid <- '20029212651'
  defaults$fachdid <- '11579986'
  defaults$facprof <- 'F'
  defaults$mas <- '9'
  defaults$mdc <- '01'
  defaults$medicare <- '1'
  ...
  defaults$seqnum <- '2563569'
  defaults$sex <- '2'
  defaults$stdplac <- '31'
  defaults$stdprov <- '31'
  defaults$stdrace <- '1'
  defaults$svcdate <- '2017-08-01'
  defaults$svcscat <- '10210'
  defaults$tsvcdat <- '2014-03-31'
  defaults$version <- '10'
  defaults$year <- '2017'
