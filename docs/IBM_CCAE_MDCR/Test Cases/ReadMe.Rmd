...
This package is intended to test the conversion of the IBM Marketscan® Commercial Claims and Encounters (CCAE), Medicare (MDCR), and Medicaid (MDCD) databases to the OMOP Common Data Model version 5.3 according to the ETL document available [here](https://ohdsi.github.io/ETL-LambdaBuilder/docs/Optum_Clinformatics).
