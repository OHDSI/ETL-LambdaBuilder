...
createCostTests <- function () {
  ...
  declareTest(id = patient$person_id, "Cost. Patient has values in ingcost, dispfee and AWP (HIX-1319). Id is PERSON_ID.")
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Patient has cost values, cost is correctly associated with cost_domain_id = 10. Id is PERSON_ID.")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Patient has procedure with domain = measurement, measurement record created. Id is PERSON_ID.")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Patient has procedure with domain = observation, observation record created. Id is PERSON_ID.")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Patient has cost values and revenue code, cost is correctly associated with cost_domain_id = 10. Id is PERSON_ID.")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Testing DRG Populates (HIX-1431). Id is PERSON_ID.")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  add_inpatient_services(caseid = encounter$caseid, enrolid = patient$enrolid, proc1 = NULL, revcode = '0420', svcdate = '2012-06-05', tsvcdat = '2012-06-05', copay = '80', deduct = '20', year = '2012')
  add_inpatient_admissions(caseid = encounter$caseid, enrolid = patient$enrolid, year = '2012')
  expect_cost(cost_domain_id = 'Procedure', paid_patient_copay = '80', paid_patient_deductible = '20', paid_by_patient = '100')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Patient has cost values, cost is correctly associated with the right event_id (HIX-1515).")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  add_inpatient_services(caseid = encounter$caseid, enrolid = patient$enrolid, proc1 = '65779', svcdate = '2012-06-11', tsvcdat = '2012-06-30', copay = '40', deduct = '120', year = '2012')
  add_inpatient_admissions(caseid = encounter$caseid, enrolid = patient$enrolid, year = '2012')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. Patient has invalid revenue code, revenue_code_concept_id set to 0. Id is PERSON_ID. (HIX-1486)")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. DRUG_CLAIMS constants")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  add_inpatient_services(caseid = encounter$caseid, enrolid = patient$enrolid, proc1 = '65779', svcdate = '2012-06-05', tsvcdat = '2012-06-05', copay = '80', deduct = '20', year = '2012')
  add_inpatient_admissions(caseid = encounter$caseid, enrolid = patient$enrolid, year = '2012')
  add_drug_claims(enrolid = patient$enrolid)
  event_ID <- lookup_procedure_occurrence(fetchField = "procedure_occurrence_id", person_id = patient$person_id)
  expect_cost(cost_event_id = event_ID, 
              cost_domain_id = 'Visit Detail',
              cost_type_concept_id = 32869,
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. OUTPATIENT_SERVICES constants")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  add_inpatient_services(caseid = encounter$caseid, enrolid = patient$enrolid, proc1 = '65779', svcdate = '2012-06-05', tsvcdat = '2012-06-05', copay = '80', deduct = '20', year = '2012')
  add_inpatient_admissions(caseid = encounter$caseid, enrolid = patient$enrolid, year = '2012')
  add_outpatient_services(enrolid = patient$enrolid)
  event_ID <- lookup_procedure_occurrence(fetchField = "procedure_occurrence_id", person_id = patient$person_id)
  expect_cost(cost_event_id = event_ID, 
              cost_domain_id = 'Visit Detail',
              cost_type_concept_id = 32860,
              currency_concept_id = 44818668,
              revenue_code_concept_id = 0,
              drg_concept_id = 0)
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. INPATIENT_SERVICES constants")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  add_inpatient_services(caseid = encounter$caseid, enrolid = patient$enrolid, proc1 = '65779', svcdate = '2012-06-05', tsvcdat = '2012-06-05', copay = '80', deduct = '20', year = '2012')
  add_inpatient_admissions(caseid = encounter$caseid, enrolid = patient$enrolid, year = '2012')
  event_ID <- lookup_procedure_occurrence(fetchField = "procedure_occurrence_id", person_id = patient$person_id)
  ...
  patient <- createPatient()
  encounter <- createEncounter()
  declareTest(id = patient$person_id, "Cost. INPATIENT_ADMISSIONS constants")
  add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
  add_inpatient_services(caseid = encounter$caseid, enrolid = patient$enrolid, proc1 = '65779', svcdate = '2012-06-05', tsvcdat = '2012-06-05', copay = '80', deduct = '20', year = '2012')
  add_inpatient_admissions(caseid = encounter$caseid, enrolid = patient$enrolid, year = '2012')
  event_ID <- lookup_procedure_occurrence(fetchField = "procedure_occurrence_id", person_id = patient$person_id)
  ...
  if (frameworkType == "MDCD")
  {
    patient <- createPatient()
    encounter <- createEncounter()
    declareTest(id = patient$person_id, "Cost. Patient has record with costs in ltc, cost record created. Id is PERSON_ID.")
    add_enrollment_detail(enrolid=patient$enrolid, dtend = '2012-12-31', dtstart = '2012-01-01')
