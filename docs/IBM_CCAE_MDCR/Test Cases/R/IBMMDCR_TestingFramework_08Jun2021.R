initFramework <- function() {
  ...
  defaults <- list()
  defaults$flag <- '0'
  defaults$admdate <- '2013-01-07'
  defaults$admtyp <- '2'
  defaults$age <- '77'
  defaults$agegrp <- '6'
  defaults$cap_svc <- 'N'
  defaults$caseid <- '181449'
  defaults$cob <- '0.0'
  defaults$coins <- '0.0'
  defaults$copay <- '0.0'
  defaults$datatyp <- '3'
  ...
  defaults$pddate <- ''
  defaults$svcdate <- '2017-07-26'
  defaults$msa <- ''
  defaults$orderid <- '200083'
  defaults$provid <- ''
