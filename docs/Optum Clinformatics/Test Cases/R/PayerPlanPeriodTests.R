createPayerPlanPeriodTests <- function()
{
  ...
  add_member_enrollment(aso = 'N', bus = 'CMO', cdhp = 3, eligeff = '2000-10-01', eligend = '2000-10-31',
                    gdr_cd = 'M', patid = patient$patid, pat_planid = patient$patid, product = 'HMO', yrdob = 1969)
  add_member_enrollment(aso = 'Y', bus = 'CMO', cdhp = 3, eligeff = '2000-10-01', eligend = '2000-10-31',
  ...
  add_member_enrollment(aso = 'N', bus = 'MCR', cdhp = 3, eligeff = '2006-01-01', eligend = '2006-05-31',
                    gdr_cd = 'M', patid = patient$patid, pat_planid = patient$patid, product = 'HMO', yrdob = 1969)
  ...
  patient <- createPatient()
  declareTest("Checks the PAYER_PLAN_SOURCE_VALUE mapping for all combos of source values.", id = patient$person_id)
  add_member_enrollment(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2000-05-01', eligend = '2015-12-31',
                    gdr_cd = 'M', patid = patient$patid, pat_planid = patient$patid, product = 'HMO', yrdob = 1969)
  ...
  patient <- createPatient()
  declareTest("Checks the PAYER_PLAN_SOURCE_VALUE mapping for all combos of source values.", id = patient$person_id)
  add_member_enrollment(aso = 'Y', bus = 'COM', cdhp = 3, eligeff = '2000-05-01', eligend = '2002-06-30',
  ...
  patient <- createPatient()
  declareTest("Checks the PAYER_PLAN_SOURCE_VALUE mapping for all combos of source values.", id = patient$person_id)
  add_member_enrollment(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2000-05-01', eligend = '2001-12-31',
                    gdr_cd = 'M', patid = patient$patid, pat_planid = patient$patid, product = 'HMO', yrdob = 1969)
  expect_payer_plan_period(person_id = patient$person_id, payer_source_value = 'COM Health Maint Org')
  ...
  patient <- createPatient()
  declareTest("Checks the PAYER_PLAN_SOURCE_VALUE mapping for all combos of source values.", id = patient$person_id)
  add_member_enrollment(aso = 'Y', bus = 'COM', cdhp = 3, eligeff = '2000-05-01', eligend = '2001-12-31',
                    gdr_cd = 'M', patid = patient$patid, pat_planid = patient$patid, product = 'EPO', yrdob = 1969)
  ...
  patient <- createPatient()
  declareTest("Checks the PAYER_PLAN_SOURCE_VALUE mapping for all combos of source values.", id = patient$person_id)
  add_member_enrollment(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2000-09-01', eligend = '2001-12-31',
  ...
  patient <- createPatient()
  declareTest("Checks the PAYER_PLAN_SOURCE_VALUE mapping for all combos of source values.", id = patient$person_id)
  add_member_enrollment(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2003-11-01', eligend = '2004-01-31',
