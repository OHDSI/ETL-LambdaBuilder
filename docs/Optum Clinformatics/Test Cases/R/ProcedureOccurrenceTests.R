createProcedureOccurrenceTests <- function()
{
  ...
  add_medical_claims(clmid = claim$clmid, clmseq = '001', proc_cd = '92928', lst_dt = '2013-07-01', loc_cd = '1',
  ...
  #expect_count_procedure_occurrence(person_id = patient$person_id, rowCount = 2) At this point we did not dedup records
