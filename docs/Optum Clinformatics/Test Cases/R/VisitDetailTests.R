createVisitDetailTests <- function() {
  ...
  add_member_enrollment(patid = patient$patid, eligeff = '2011-05-01', eligend = '2013-05-13')						   
  ...
  add_rx_claims(patid = patient$patid, pat_planid = patient$patid, fill_dt = '2012-02-02', days_sup = 30, mail_ind = 'N')
  expect_visit_detail(person_id = patient$person_id, visit_detail_concept_id = 581458, visit_detail_start_date = '2012-02-02')
  ...
  add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  add_member_enrollment(patid = patient$patid, eligeff = '2010-05-01', eligend = '2013-10-31')								   
  add_rx_claims(patid = patient$patid, pat_planid = patient$patid, fill_dt = '2012-02-03', days_sup = -25, mail_ind = 'N')
  expect_visit_detail(person_id = patient$person_id, visit_detail_concept_id = 581458, visit_detail_start_date = '2012-02-03', visit_detail_end_date = '2012-02-03')
  
  
  patient <- createPatient()
  claim <- createClaim()
  declareTest("VISIT_DETAIL - Record in rx_claims with days_sup > 365 should set visit_detail_end_date = fill_dt", #PASS v2.0.0.19
              id = patient$person_id)
  add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  add_member_enrollment(patid = patient$patid, eligeff = '2010-05-01', eligend = '2013-10-31')								   
  add_rx_claims(patid = patient$patid, pat_planid = patient$patid, fill_dt = '2012-02-04', days_sup = 400, mail_ind = 'N')
  expect_visit_detail(person_id = patient$person_id, visit_detail_concept_id = 581458, visit_detail_start_date = '2012-02-04', visit_detail_end_date = '2012-02-04')
