createDeathTests <- function()
{
  ...
  # 
   ...
   #expect_no_death(person_id = patient$person_id)
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("DEATH - Patient has Medical data occurring <=30 days after death record.", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    #add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-31',
   ...
   #expect_no_death(person_id = patient$person_id)
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("DEATH - Patient has RX data occurring <=30 days after death record.", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    #add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_rx_claims(patid = patient$patid, pat_planid = patient$patid, clmid = claim$clmid, ndc = '55111067101', fill_dt = '2013-07-31')
   ...
   #expect_no_death(person_id = patient$person_id)
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("DEATH - Patient has Lab data occurring <=30 days after death record.", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    #add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_lab_results(labclmid = claim$clmid, loinc_cd = '48868-4', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-31')
   ...
   #expect_no_death(person_id = patient$person_id)
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("DEATH - Patient has Observation data occurring <=30 days after death record", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    #add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-31', proc_cd = '64475',
