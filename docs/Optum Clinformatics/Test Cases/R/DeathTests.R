createDeathTests <- function()
{
  ...
  # claim <- createClaim()
  # declareTest("Patient is indicated dead by diag source code (ICD9CM).", id = patient$person_id)
  ...
  # patient <- createPatient()
  # claim <- createClaim()
  # declareTest("Patient is indicated dead by diag source code (ICD10CM).", id = patient$person_id)
  # add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
  #                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  # add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-01',
  #                    pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  ...
  # patient <- createPatient()
  # claim <- createClaim()
  # declareTest("Patient has medical diagnosis data occurring <=30 days after death event.", id = patient$person_id)
  # add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
  #                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  # add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-01',
  #                    pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  ...
  # patient <- createPatient()
  # claim <- createClaim()
  # declareTest("Patient has RX data occurring <=30 days after death event.", id = patient$person_id)
  # add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
  #                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  # add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-01',
  #                    pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  ...
  # patient <- createPatient()
  # claim <- createClaim()
  # declareTest("Patient has Lab data occurring <=30 days after death event.", id = patient$person_id)
  # add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
  #                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  # add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-01',
  #                    pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  ...
  # patient <- createPatient()
  # claim <- createClaim()
  # declareTest("Patient has Observation data occurring <=30 days after death event.", id = patient$person_id)
  # add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
  #                   gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
  # add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-01',
  #                    pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  ...
  # 
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient has valid death record", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient has invalid death record after DOB", id = patient$person_id)
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient has Medical data occurring <=30 days after death record.", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-31',
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient has RX data occurring <=30 days after death record.", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_rx_claims(patid = patient$patid, pat_planid = patient$patid, clmid = claim$clmid, ndc = '55111067101', fill_dt = '2013-07-31')
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient has Lab data occurring <=30 days after death record.", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_lab_results(labclmid = claim$clmid, loinc_cd = '48868-4', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-31')
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient has Observation data occurring <=30 days after death record", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_medical_claims(clmid = claim$clmid, clmseq = '001', lst_dt = '2013-07-31', proc_cd = '64475',
    ...
    patient <- createPatient()
    claim <- createClaim()
    declareTest("Patient ICD9 for death and a record in the death table", id = patient$person_id)
    add_member_continuous_enrollment(eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, yrdob = 1969)
    add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
