...
VISIT_DETAIL_END_DATE|**MEDICAL_CLAIMS** LST_DT<br><br>**RX_CLAIMS** FILL_DT+DAYS_SUP<br>If DAYS_SUP is 0 or empty then do **RX_CLAIMS** FILL_DT+1<br><br>**INPATIENT_CONFINEMENT** Disch_Date||
