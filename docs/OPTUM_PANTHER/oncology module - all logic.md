...
<p>
Note, for now not merge only histology or only neoplasm entries using a <a href="#heading=h.1fob9te">query</a><span style="text-decoration:underline;"> because several cancers can be presents at one day</span>
<p>
...
Where source_vocabulary_id = ‘JNJ_OPTUM_EHR_ONCNHC’ and Target_standard_concept = ‘S’ and target_invalid_reason is NULL 
...
<p>
4181412 -- <a href="https://athena.ohdsi.org/search-terms/terms/4181412">Present</a><span style="text-decoration:underline;"> </span>
   </td>
   <td>
   </td>
  </tr>
