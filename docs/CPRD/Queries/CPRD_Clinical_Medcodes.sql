--Query to map medcodes in the CPRD clinical table to vocabulary.
--This is not the official way but can give an idea to the different domains
--represented in the table.

select c.medcode as clinical_medcode,
       m.read_code,
