createPersonTests <- function()
{
  ...
  expect_person(person_id = lookup_person("person_id", person_source_value = patient$person_id), year_of_birth = 1999, month_of_birth = 1, care_site_id = patient$pracid, gender_concept_id = 8507,
  ...
  add_patient(patid=patient$patid,gender=1, yob=199, mob=0, accept=1, crd='2010-01-01', deathdate=NULL, tod=NULL,
              pracid=patient$pracid)
  expect_person(person_id = lookup_person("person_id", person_source_value = patient$person_id), year_of_birth = 1999, month_of_birth = NULL, care_site_id = patient$pracid, gender_concept_id = 8507,
                person_source_value = patient$patid, gender_source_value = 1)
  ...
  add_patient(patid=patient$patid,gender=2, yob=195, mob=1, accept=1, crd='2010-01-01', deathdate=NULL, tod=NULL,
              pracid=patient$pracid)
  expect_person(person_id = lookup_person("person_id", person_source_value = patient$person_id), care_site_id = patient$pracid, gender_concept_id = 8532,
