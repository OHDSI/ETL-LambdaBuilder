createVisitOccurrenceTests <- function()
{
  ...
  declareTest(id = patient$person_id, "Multiple consides on the same date but no event record, no visit created.")
  ...
  expect_no_visit_occurrence(person_id = patient$person_id, visit_start_date = '2013-02-01', visit_end_date = '2013-02-01'
                          )
