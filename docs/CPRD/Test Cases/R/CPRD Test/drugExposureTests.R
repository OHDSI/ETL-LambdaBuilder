createDrugExposureTests <- function()
{
  ...
  expect_drug_exposure(person_id =  lookup_person("person_id", person_source_value = patient$person_id), drug_concept_id = 19073982,
                       drug_source_value = 58976020, quantity = 1, refills = 1,
                       drug_exposure_end_date = '2012-1-29')
  expect_count_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id), rowCount = 1)
  ...
  add_consultation(patid =  patient$patid, eventdate = '2012-01-01', staffid = 9001)
  expect_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id),drug_concept_id = 1539463, drug_source_value = 72487020, quantity = 1, refills = 1,
  ...
  add_therapy(patid =  patient$patid, eventdate = '2012-01-01', prodcode = 9999, qty = 1, numpacks = 0,
              issueseq = 1, numdays = 0, staffid = 9001)
  add_consultation(patid =  patient$patid, eventdate = '2012-01-01', staffid = 9001)
  expect_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id),drug_source_value = 93680020, quantity = 1, refills = 1,
                       drug_exposure_end_date = '2012-1-1')
  expect_count_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id), rowCount = 1)
  ...
  add_consultation(patid = patient$patid, eventdate = '2012-01-01', staffid = 9001)
  expect_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id),drug_concept_id = 19073982, drug_source_value  = 58976020, quantity = 1, refills = 1,
  ...
  expect_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id), drug_exposure_start_date = '2012-03-12',
  ...
  add_therapy(patid = patient$patid, eventdate = '2012-01-01', prodcode = 2, qty = 1, numpacks = 0,
              issueseq = 1, numdays = 366, staffid = 9001)
  expect_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id), drug_exposure_start_date = '2012-01-01',
                       drug_concept_id = 19073982, drug_source_value  = 58976020, quantity = 1, refills = 1,
                       drug_exposure_end_date = '2012-1-29')
  expect_count_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id), rowCount = 1)
  ...
  add_therapy(patid = patient$patid, eventdate = '2012-01-01', prodcode = -1, qty = 1, numpacks = 0,
              issueseq = 1, numdays = 366, staffid = 9001)
  add_consultation(patid = patient$patid, eventdate = '2012-01-01', staffid = 9001)
  expect_no_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id))
  ...
  # no needed anymore, all statuses are valid
  # expect_no_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id))
  expect_drug_exposure(person_id = lookup_person("person_id", person_source_value = patient$person_id))

  # 12) -- immunization with visit -- now goes to procedure
  add_medical(medcode=1, read_code = '65M4.00')
  ...
  add_consultation(patid = patient$patid, eventdate = '2012-01-01', staffid = 9001)
  expect_procedure_occurrence(person_id = lookup_person("person_id", person_source_value = patient$person_id),
                       procedure_concept_id = 44792015,
                       procedure_source_concept_id = 45498792, procedure_source_value = '65M4.00',
                       procedure_type_concept_id = 32818, procedure_date = '2012-01-01')
  expect_count_procedure_occurrence(person_id = lookup_person("person_id", person_source_value = patient$person_id), rowCount = 1)
  ...
  expect_procedure_occurrence(person_id = lookup_person("person_id", person_source_value = patient$person_id),
                       procedure_concept_id = 44792015,
                       procedure_source_concept_id = 45498792, procedure_source_value = '65M4.00',
                       procedure_type_concept_id = 32817, procedure_date = '2009-03-01')
  ...
  expect_condition_occurrence(person_id = lookup_person("person_id", person_source_value = patient$person_id))
  ...
  #                      drug_source_concept_id = 45498792, drug_source_value = '215--65M4.00',
