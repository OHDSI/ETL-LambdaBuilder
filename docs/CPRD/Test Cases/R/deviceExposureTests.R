createDeviceExposureTests <- function()
{
  ...
  expect_device_exposure(person_id = patient$person_id, device_concept_id = 21380480, device_source_value =  99978020,
                       device_exposure_start_date = '2012-01-01')
  expect_count_device_exposure(person_id = patient$person_id, rowCount = 1)
