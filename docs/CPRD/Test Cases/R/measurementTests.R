createMeasurementTests <- function()
{
  ...
  expect_measurement(person_id = lookup_person("person_id", person_source_value = patient$person_id),
  ...
  expect_measurement(person_id = lookup_person("person_id", person_source_value = patient$person_id), #measurement_concept_id =  40487136,#4064622,
                     measurement_date =  '2011-03-01',
                     measurement_concept_id =  4132152,
                     measurement_source_value =  '424Z.00', measurement_source_concept_id =  45508441,
                     provider_id =   1001)
  ...
  expect_measurement(person_id = lookup_person("person_id", person_source_value = patient$person_id),
                     ...
                     measurement_source_value =  '424Z.00', # medcode = 445, read_code = '424Z.00'
  ...
  expect_measurement(person_id = lookup_person("person_id", person_source_value = patient$person_id), measurement_concept_id=4015178,
                     measurement_date= '2012-01-01',
                     measurement_type_concept_id=32856, # Data Not Entered
                     value_as_number=14.30, value_as_concept_id=NULL,
  ...
  expect_measurement(person_id = lookup_person("person_id", person_source_value = patient$person_id), measurement_concept_id=3031455,
                     measurement_date='2012-01-01',
                     measurement_type_concept_id=32856
                     #17-Dec-1998 00:00:00',
                     )

  #expect_count_measurement(rowCount = 2, person_id = lookup_person("person_id", person_source_value = patient$person_id))


  # 21) -- test observation record enttype=311
  # If an entity type is mapped to concept_id 0, put the domain_id as Observation.
  patient <- createPatient();
  ...
  ##add_lookuptype(lookup_type_id = 81, name='SUM', description = 'Specimen ...')
  expect_measurement(person_id = lookup_person("person_id", person_source_value = patient$person_id), measurement_concept_id=4197249,
                     measurement_date='2012-01-01',
                     measurement_type_concept_id=32856)
