initFramework <- function() {
  ...
  defaults <- list()
  defaults$sysdate <- '2014-06-12'
  defaults$constype <- '6'
  defaults$consid <- '2591944'
  defaults$medcode <- '1'
  defaults$staffid <- '0'
  defaults$episode <- '4'
  defaults$enttype <- '2'
  ...
  defaults <- list()
  defaults$patid <- '8789506'
  defaults$eventdate <- '2010-02-04'
  defaults$staffid <- '0'
  defaults$sysdate <- '2014-06-12'
  defaults$constype <- '2'
  defaults$medcode <- '5'
  ...
  defaults <- list()
  defaults$patid <- '8930398'
  defaults$eventdate <- '2013-12-02'
  defaults$sysdate <- '2015-08-03'
  defaults$prodcode <- '3'
  defaults$staffid <- '0'
...
set_defaults_test <- function(patid, eventdate, consid, staffid, sysdate, constype, medcode, enttype, data1, data2, data3, data4, data5, data6, data7, data8_value, data8_date) {
...
add_test <- function(patid, eventdate, consid, staffid, sysdate, constype, medcode, enttype, data1, data2, data3, data4, data5, data6, data7, data8_value, data8_date) {
  defaults <- get('test', envir = frameworkContext$defaultValues)
  fields <- c()
  values <- c()
  if (missing(patid)) {
...
expect_measurement <- function(measurement_id, person_id, visit_occurrence_id, measurement_concept_id, measurement_date, measurement_datetime, measurement_time, measurement_type_concept_id, operator_concept_id, value_as_number, value_as_concept_id, range_low, range_high, unit_concept_id, provider_id, visit_detail_id, measurement_source_value, measurement_source_concept_id, unit_source_value, value_source_value) {
  fields <- c()
  values <- c()
...
expect_count_measurement <- function(rowCount, measurement_id, person_id, visit_occurrence_id, measurement_concept_id, measurement_date, measurement_datetime, measurement_time, measurement_type_concept_id, operator_concept_id, value_as_number, value_as_concept_id, range_low, range_high, unit_concept_id, provider_id, visit_detail_id, measurement_source_value, measurement_source_concept_id, unit_source_value, value_source_value) {
  fields <- c()
  values <- c()
  if (!missing(measurement_id)) {
    fields <- c(fields, "measurement_id")
...
lookup_measurement <- function(fetchField, measurement_id, person_id, visit_occurrence_id, measurement_concept_id, measurement_date, measurement_datetime, measurement_time, measurement_type_concept_id, operator_concept_id, value_as_number, value_as_concept_id, range_low, range_high, unit_concept_id, provider_id, visit_detail_id, measurement_source_value, measurement_source_concept_id, unit_source_value, value_source_value) {
